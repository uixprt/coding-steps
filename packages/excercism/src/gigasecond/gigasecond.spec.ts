...
describe("Gigasecond", () => {
  ...
  test.skip("tells a gigasecond anniversary since midnight", () => {
  ...
  test.skip("tells another gigasecond anniversary since midnight", () => {
  ...
  test.skip("tells gigasecond anniversary since midnight, from before UNIX epoch", () => {
  ...
  // full time specified
  test.skip("tells the anniversary, including a time", () => {
  ...
  test.skip("tells the anniversary is next day when you are born at night", () => {
